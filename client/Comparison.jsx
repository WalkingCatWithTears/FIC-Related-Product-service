...
export default function Comparison(props) {
    return (
        <div className=" bg-opacity-50 absolute inset-0 flex justify-center items-center" onClick={()=>props.exit(false)}>
            <div className="bg-gray-200 max-w-md py-2 px-2 border-2 border-black">
